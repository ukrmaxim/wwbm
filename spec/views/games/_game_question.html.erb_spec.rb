...
RSpec.describe 'games/game_question', type: :view do
  # Создадим тестовый объект game_question, который будет доступен в каждом it, где он понадобится
  ...
  before(:each) do
    ...
    # Мы просто говорим тесту, что нужно вернуть каждому из них
    # Подробнее про allow читайте в документации rspec https://relishapp.com/rspec/rspec-mocks/v/3-4/docs
