...
class GamesController < ApplicationController
  ...
  def answer
    ...
    unless @answer_is_correct
      flash[:alert] = t('controllers.games.bad_answer', answer: @game_question.correct_answer,
  ...
  def goto_game_in_progress!
    ...
    unless game_in_progress.blank?
      redirect_to game_path(game_in_progress), alert: t('controllers.games.game_not_finished')
    end
  end
